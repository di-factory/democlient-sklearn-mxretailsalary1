...
def main(cfg: DictConfig) -> None:
    ...
    try:
        joblib.dump(experiment, os.path.join(cfg.paths.flask_app_dir, cfg.file_names.flask_predict_model))
        print("Flask model saved successfully!")
    except Exception as e:
        print(f"Error saving the flask predict model: {e}")    
